...
namespace RedBjorn.ProtoTiles
{
    ...
    {
        public Dictionary<Vector3Int, TileEntity> Tiles;
        public Func<Vector3Int, Vector3Int, float> DistanceFunc;
        public Vector3Int[] NeighboursDirection { get; set; }

        public MapEntityMock()
        {
            Tiles = new Dictionary<Vector3Int, TileEntity>();
        }

        public MapEntityMock(int capacity)
        {
            Tiles = new Dictionary<Vector3Int, TileEntity>(capacity);
        }
