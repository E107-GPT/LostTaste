...
namespace RedBjorn.ProtoTiles
{
    public class HexPointy
    {
        public class Matrix
        {
            ...
            {
                public const float x11 = Constants.Sqrt3 / 3f;
                public const float x12 = -1f / 3f;
                public const float x21 = 0f;
                public const float x22 = 2f / 3f;
            }

            public class ToWorld
            {
                public const float x11 = Constants.Sqrt3;
                public const float x12 = Constants.Cos30;
                public const float x21 = 0f;
                public const float x22 = 1.5f;
            }
        }
        ...
        static readonly Vector3[] VerticesXZ = new Vector3[]
        {
            ...
            new Vector3( Constants.Cos30, 0f,  Constants.Cos60),
            new Vector3( Constants.Cos30, 0f, -Constants.Cos60),
            new Vector3( 0f             , 0f, -1f),
            new Vector3(-Constants.Cos30, 0f, -Constants.Cos60),
            new Vector3(-Constants.Cos30, 0f,  Constants.Cos60)
        ...
        static readonly Vector3[] VerticesXY = new Vector3[]
        {
            ...
            new Vector3( Constants.Cos30,  Constants.Cos60, 0f),
            new Vector3( Constants.Cos30, -Constants.Cos60, 0f),
            new Vector3( 0f             , -1f, 0f),
            new Vector3(-Constants.Cos30, -Constants.Cos60, 0f),
            new Vector3(-Constants.Cos30,  Constants.Cos60, 0f)
        ...
        {
            new Vector3(0f,  1f,               0f),
            new Vector3(0f,  Constants.Cos60,  Constants.Cos30),
            new Vector3(0f, -Constants.Cos60,  Constants.Cos30),
            new Vector3(0f, -1f,               0f),
            new Vector3(0f, -Constants.Cos60, -Constants.Cos30),
            new Vector3(0f,  Constants.Cos60, -Constants.Cos30)
        ...
        {
            return (Array.IndexOf(Hex.Neighbour, direction) + 1) % Hex.Neighbour.Length;
        }
