...
Shader "Smoke Dome"
{
	Properties
	{
		...
		_Emission("Emission", Range( 0 , 100)) = 5.32
		_SoftParticleFactor("Soft Particle Factor", Range( 0 , 0.999)) = 0.5
		[ASEEnd]_Color("Color ", Color) = (1,0.4622855,0.2122642,1)
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 texCoord15 = IN.ase_texcoord3.xy * _Texturesize + float2( 0,0 );
				float2 panner14 = ( 1.0 * _Time.y * float2( 0.2,0 ) + texCoord15);
				float2 texCoord16 = IN.ase_texcoord3.xy * _Texturesize2 + float2( 0,0 );
				float2 panner17 = ( 1.0 * _Time.y * float2( 0.2,0 ) + texCoord16);
				float2 texCoord21 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner20 = ( 1.0 * _Time.y * float2( 1,0 ) + texCoord21);
				float4 temp_output_22_0 = ( tex2D( _Noise17, ( float4( panner14, 0.0 , 0.0 ) + tex2D( _Noise5, panner17 ) ).rg ) * tex2D( _T_VFX_Trail_03, panner20 ) );
				...
				float3 Color = ( temp_output_22_0 * _Emission * IN.ase_color * _Color ).rgb;
				float Alpha = ( temp_output_22_0 * IN.ase_color.a * saturate( ( ( 1.0 - _SoftParticleFactor ) * ( eyeDepth28 - screenPos.w ) * 3.0 ) ) ).r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 texCoord15 = IN.ase_texcoord2.xy * _Texturesize + float2( 0,0 );
				float2 panner14 = ( 1.0 * _Time.y * float2( 0.2,0 ) + texCoord15);
				float2 texCoord16 = IN.ase_texcoord2.xy * _Texturesize2 + float2( 0,0 );
				float2 panner17 = ( 1.0 * _Time.y * float2( 0.2,0 ) + texCoord16);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 texCoord15 = IN.ase_texcoord.xy * _Texturesize + float2( 0,0 );
				float2 panner14 = ( 1.0 * _Time.y * float2( 0.2,0 ) + texCoord15);
				float2 texCoord16 = IN.ase_texcoord.xy * _Texturesize2 + float2( 0,0 );
				float2 panner17 = ( 1.0 * _Time.y * float2( 0.2,0 ) + texCoord16);
				...
				surfaceDescription.Alpha = ( temp_output_22_0 * IN.ase_color.a * saturate( ( ( 1.0 - _SoftParticleFactor ) * ( eyeDepth28 - screenPos.w ) * 3.0 ) ) ).r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 texCoord15 = IN.ase_texcoord1.xy * _Texturesize + float2( 0,0 );
				float2 panner14 = ( 1.0 * _Time.y * float2( 0.2,0 ) + texCoord15);
				float2 texCoord16 = IN.ase_texcoord1.xy * _Texturesize2 + float2( 0,0 );
				float2 panner17 = ( 1.0 * _Time.y * float2( 0.2,0 ) + texCoord16);
...
Node;AmplifyShaderEditor.SamplerNode;10;-992.7295,-158.548;Inherit;True;Property;_Noise5;Noise5;0;0;Create;True;0;0;0;False;0;False;-1;24683720835d23d45a95b2bcf3908421;24683720835d23d45a95b2bcf3908421;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;19;-1576.065,-104.9611;Inherit;False;Property;_Texturesize2;Texture size2;4;0;Create;True;0;0;0;False;0;False;0.5,0.5;0.5,0.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TextureCoordinatesNode;21;-1031.9,99.28773;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;11;-545.0981,-205.2608;Inherit;True;Property;_Noise17;Noise17;1;0;Create;True;0;0;0;False;0;False;-1;66508e79a27ccad4cb1d689a4edf9633;66508e79a27ccad4cb1d689a4edf9633;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;13;-669.8112,-172.6892;Inherit;False;2;2;0;FLOAT2;0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.Vector2Node;18;-1264.998,-272.1139;Inherit;False;Property;_Texturesize;Texture size;3;0;Create;True;0;0;0;False;0;False;0.5,0.5;0.5,0.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;22;-145.5702,-81.17831;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;12;-549.9142,59.79616;Inherit;True;Property;_T_VFX_Trail_03;T_VFX_Trail_03;2;0;Create;True;0;0;0;False;0;False;-1;233f6c83619f55e4182911de14c3e1f9;233f6c83619f55e4182911de14c3e1f9;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PannerNode;20;-765.2005,99.3877;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;1,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;15;-1092.033,-291.8905;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PannerNode;14;-884.3282,-280.1611;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0.2,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;16;-1402.865,-112.9611;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PannerNode;17;-1181.865,-117.9611;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0.2,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;37;272.6665,284.0813;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;38;272.3664,141.0815;Inherit;False;4;4;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;25;-144.5232,150.625;Inherit;False;Property;_Color;Color ;7;0;Create;True;0;0;0;False;0;False;1,0.4622855,0.2122642,1;1,0.6824711,0.3349056,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VertexColorNode;35;55.55037,228.1004;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;36;69.19407,417.2085;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;34;-54.43614,416.7781;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;31;-225.796,331.0974;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;30;-501.144,326.1329;Inherit;False;Property;_SoftParticleFactor;Soft Particle Factor;6;0;Create;True;0;0;0;False;0;False;0.5;0.268;0;0.999;0;1;FLOAT;0
Node;AmplifyShaderEditor.ScreenDepthNode;28;-417.9259,398.2834;Inherit;False;0;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;32;-217.791,443.2083;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;33;-214.297,557.4257;Inherit;False;Constant;_3;3;4;0;Create;True;0;0;0;False;0;False;3;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ScreenPosInputsNode;29;-408.9239,470.3975;Float;False;1;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;464.5528,183.1201;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;Smoke Dome;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;3;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;23;Surface;1;638109033967076637;  Blend;0;638109036562525397;Two Sided;1;638109916935421176;Forward Only;0;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;False;False;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.RangedFloatNode;27;-96.02206,-203.9214;Inherit;False;Property;_Emission;Emission;5;0;Create;True;0;0;0;False;0;False;5.32;20;0;100;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=97EEC1D066C2F705B83897F5518DCCD3BE93C186