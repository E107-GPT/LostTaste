...
/// <summary>
/// UI 오브젝트에 마우스 커서가 들어오거나 나갈 때, 또는 클릭했을 때 커서 모양을 변경하는 컴포넌트입니다.
/// </summary>
public class CursorChanger : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler // IPointerClickHandler 인터페이스 추가
{
    [Header("[ 커서 이미지 ]")]
